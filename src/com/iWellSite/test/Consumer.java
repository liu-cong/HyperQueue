...
public class Consumer implements Runnable{
	...
	private void getSessionID(){
		...
		try {//set HTTP GET request and read response (session ID) from the server
	...
	public String getMessage() {//set HTTP GET request and read response (message) from the server
		HttpURLConnection con = null ;
		InputStream is = null;
